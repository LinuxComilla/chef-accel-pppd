...
default[:accel][:pptp][:ip_pool][:name] = "pptp-pool"
default[:accel][:pptp][:ip_pool][:range] = "10.1.0.2/24"
...
default[:accel][:l2tp][:ip_pool][:range] = "10.0.0.2/24"
...
default[:accel][:radius][:hosts] = {"radius1" => "192.168.1.1", "radius2" => "192.168.1.2"}
default[:accel][:radius][:secret] = "secret"
...
default[:accel][:radius][:dae_secret] = "secret"
